...
def process_html_files(directory):
    """Parcourt un répertoire pour traiter tous les fichiers HTML, y compris dans les sous-dossiers."""
...
def main():
    ...
    directory = input("Entrez le chemin du répertoire contenant les fichiers HTML (inclut les sous-dossiers) : ").strip()
